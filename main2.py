...
if __name__ == "__main__":
    register_server("192.168.1.63","Mayeul")
    register_server("192.168.1.65","George")
    register_server("192.168.1.64","George")

    print(get_servers(ip_only=True))
